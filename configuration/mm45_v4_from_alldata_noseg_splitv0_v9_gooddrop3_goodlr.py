...
class configMain:
    def __init__(self):
        ...
        # this good drop3
        #                      8192*512  512**2  input=1    640*512   512*256 256**2
        self.dropout = [1.0] * 8 + [0.5, 0.5] + [1.0] * 2 + [0.5] * 1 + [1.0, 1.0] * len(self.branch_config)
        ...
        self.number_iterations = 701000  # 500k
...
class configTrain(configMain):
    def __init__(self):
        ...
        factor = 0.33
        self.training_schedule = [[50000, 0.5], [100000, factor**2], [500000+50000, factor**3],
                                  [500000+100000, factor**4],
                                  [500000+150000, factor**5]]  # Number of iterations, multiplying factor
