    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        with slim.arg_scope([initial_block, bottleneck], is_training=is_training), \
            ...
            with slim.arg_scope([bottleneck], regularizer_prob=0.1):
                ...
                net = bottleneck(net, output_depth=64, filter_size=3, dilated=True, dilation_rate=2,
                                 scope='bottleneck2_2')
                net = bottleneck(net, output_depth=64, filter_size=5, asymmetric=True, scope='bottleneck2_3')
                net = bottleneck(net, output_depth=64, filter_size=3, dilated=True, dilation_rate=4,
                                 scope='bottleneck2_4')
                net = bottleneck(net, output_depth=64, filter_size=3, scope='bottleneck2_5')
                net = bottleneck(net, output_depth=64, filter_size=3, dilated=True, dilation_rate=8,
                                 scope='bottleneck2_6')
                net = bottleneck(net, output_depth=64, filter_size=5, asymmetric=True, scope='bottleneck2_7')
                net = bottleneck(net, output_depth=64, filter_size=3, dilated=True, dilation_rate=16,
                                 scope='bottleneck2_8')
