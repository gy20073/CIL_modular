...
class configMain:
    def __init__(self):
        ...
        self.variable_names = ['Steer', 'Gas', 'Brake', 'Hand_B', 'Reverse',
                               ...
                               'Waypoint_Shape', "Waypoint_Scale"]

        self.sensor_names = ['CameraMiddle']
        self.sensor_augments = ['SegMiddle']

        self.targets_names = ['Waypoint_Shape', "Waypoint_Scale"]
        ...
        self.branch_config = [['Waypoint_Shape', "Waypoint_Scale"]] * 4
        ...
        self.dropout = [.95] * 7 + [0.95] * 2 + [.95] * 2 + [0.95] * 1 + [0.95, 0.95, 0.95, 0.95] * len(self.branch_config)
        ...
        self.cluster_center_file = "utils/cluster_centers.npy.v3"
...
class configInput(configMain):
    def __init__(self):
        ...
        all_files = glob.glob("/data/yang/code/aws/scratch/carla_collect/steer103_v3_waypoint/*/data_*.h5")
        self.val_db_path = []
        for valid in range(1, 15, 3):
            self.val_db_path += glob.glob(
                "/data/yang/code/aws/scratch/carla_collect/steer103_v3_waypoint/*WeatherId=" + str(valid).zfill(
                    2) + "/data_*.h5")
...
class configTrain(configMain):
    def __init__(self):
        ...
        self.loss_function = 'mse_branched_cls_reg'  # Chose between: mse_branched, mse_branched_ladd
        self.control_mode = 'single_branch_yang_cls_reg'
        # TODO: tune it
        ...
        self.branch_loss_weight = [0.95, 0.95, 0.95, 0.95]
        self.variable_weight = {'Waypoint_Shape' : 1.0, "Waypoint_Scale": 1.0}

        self.network_name = 'yang_39_52_295_v2_cls_reg'
