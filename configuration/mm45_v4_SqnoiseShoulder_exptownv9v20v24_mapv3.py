...
dataset_ids = ['exptown_v9_noise75_way', 'exptown_v20_park_overexplore_way', 'steer103_v5_way_v2', 'steer103_v5_way_v2_town02', 'exptown_v24_park_nocar_way']
def changing(self):
    # less map
    # merge follow and straight
    self.perception_gpus = [4, 5]
    self.map_pos_noise_std = 0.5
    self.mapping_version = "v3"
...
class configMain:
    def __init__(self):
        ...
        self.map_height = 50
        self.map_pos_noise_std = 0.1  # measured in meter
        ...
        if self.use_perception_stack:
            ...
            # debug
            self.feature_input_size = (39, 52, 6*9*3)
        else:
