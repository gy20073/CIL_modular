...
if __name__ == '__main__':
    ...
    for file in files_parsed:
        ...
        infractions = [lane_road[0] / km_run, lane_road[1] / km_run, colisions[0] / km_run, colisions[1] / km_run,
                       colisions[2] / km_run]
        infractions_vec = [sum(x) for x in zip(infractions, infractions_vec)]
        print(
        'Non_Colisions/Km', (infractions[1] + infractions[0]) / 2.0, 'Lane Cross/Km ', infractions[0], 'Side Cross/Km ',
        infractions[1], 'Col Gen /Km ', infractions[2] \
            , 'Col Ped /Km ', infractions[3], 'Col Ped /Km ', infractions[4], 'Acidents/Km ',
        (infractions[4] + infractions[2] + infractions[3]) / 3, \
