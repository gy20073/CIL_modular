...
def create_structure(tf, input_image, input_data, input_size, dropout, config):
    ...
    xc = network_manager.conv_block_nobn(x, 5, 2, 32, padding_in='VALID')
    print(xc)
    xc = network_manager.conv_block_nobn(xc, 3, 1, 32, padding_in='VALID')
    print(xc)

    """conv2"""
    xc = network_manager.conv_block_nobn(xc, 3, 2, 64, padding_in='VALID')
    print(xc)
    xc = network_manager.conv_block_nobn(xc, 3, 1, 64, padding_in='VALID')
    print(xc)

    """conv3"""
    xc = network_manager.conv_block_nobn(xc, 3, 2, 128, padding_in='VALID')
    print(xc)
    xc = network_manager.conv_block_nobn(xc, 3, 1, 128, padding_in='VALID')
    print(xc)

    """conv4"""
    xc = network_manager.conv_block_nobn(xc, 3, 1, 256, padding_in='VALID')
    print(xc)
    xc = network_manager.conv_block_nobn(xc, 3, 1, 256, padding_in='VALID')
    print(xc)
    """mp3 (default values)"""
