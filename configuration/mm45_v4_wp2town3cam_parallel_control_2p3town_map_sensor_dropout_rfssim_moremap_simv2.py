...
class configMain:
    def __init__(self):
        ...
        self.map_height = 50
        self.map_pos_noise_std = 1.0  # measured in meter
        self.map_yaw_noise_std = 1.0 # in degree
...
class configInput(configMain):
    def __init__(self):
        ...
        all_files = []
        self.val_db_path = []
        ids = ["steer103_v5_way_v2", 'steer103_v5_way_v2_town02', 'rfs_sim_v2_way']
