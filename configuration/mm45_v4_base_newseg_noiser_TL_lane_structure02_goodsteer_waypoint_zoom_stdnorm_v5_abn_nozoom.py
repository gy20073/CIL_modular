...
class configMain:
    def __init__(self):
        ...
        self.perception_gpus = [0, 4]
        self.perception_paths = "path_jormungandr_newseg"
        self.perception_batch_sizes = {"det_COCO": 3, "det_TL": 3, "seg": 4, "depth": 4, "det_TS": -1, "seg_abn": 2}
        self.perception_num_replicates = {"det_COCO": -1, "det_TL": -1, "seg": -1, "depth": -1, "det_TS": -1, "seg_abn": 2}
        # debug
        ...
        if self.use_perception_stack:
            ...
            # debug
            self.feature_input_size = (39, 52, 65*4)
        else:
