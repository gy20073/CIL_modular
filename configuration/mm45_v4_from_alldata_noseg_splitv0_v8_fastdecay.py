...
class configInput(configMain):
    def __init__(self):
        ...
        all_files = glob.glob("/data/yang/code/aws/scratch/carla_collect/8/*/data_*.h5")
        self.val_db_path = glob.glob("/data/yang/code/aws/scratch/carla_collect/8/*WeatherId=13/data_*.h5")
...
class configTrain(configMain):
    def __init__(self):
        ...
        self.training_schedule = [[30000, 0.1], [100000, 0.01]]  # Number of iterations, multiplying factor
