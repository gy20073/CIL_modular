class configDrive:
    def __init__(self):
        ...
        self.host = "127.0.0.1"
        self.port = 2000
        self.path = "/scratch/yang/aws_data/carla_collect/rfs_sim_v3/"  # If path is set go for it , if not expect a name set
        ...
        if self.city_name == "RFS_MAP":
            ...
            self.extra_explore_prob = 0.1 # now for debugging purpose, let all of them be the extra positions file
