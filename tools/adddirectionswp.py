...
with  open('/media/matthias/7E0CF8640CF818BB/Github/chauffeur/drive_interfaces/carla_interface/carla_1.txt',
           'r') as file:
    ...
    worldrotation = np.array([[math.cos(math.radians(angles[2])), -math.sin(math.radians(angles[2])), 0.0],
...
map_image = Image.open(
    '/media/matthias/7E0CF8640CF818BB/Github/chauffeur/drive_interfaces/carla_interface/carla_1p.png')
map_image.load()
...
if __name__ == "__main__":
    ...
    plt.plot(list(range(0, direction.shape[0])), direction,
             'g')  # range(0,len(speed_list)),speed_list_noise,'b',range(0,len(speed_list)),just_noise,'r')
