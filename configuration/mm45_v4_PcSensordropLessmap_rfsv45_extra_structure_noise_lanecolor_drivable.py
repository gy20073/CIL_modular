...
class configMain:
    def __init__(self):
        ...
        self.perception_batch_sizes = {"det_COCO": 3, "det_TL": 3, "seg": 4, "depth": 4, "det_TS": -1, "drivable_area": 4}
        self.perception_num_replicates = {"det_COCO": -1, "det_TL": -1, "seg": 3, "depth": -1, "det_TS": -1, "drivable_area": 3}
        self.perception_other_params = {"add_lane_color": True}
        # debug
        ...
        if self.use_perception_stack:
            ...
            # debug
            self.feature_input_size = (39, 52, (6+3)*9*3 + 3*9*3)
        else:
...
class configTrain(configMain):
    def __init__(self):
        ...
        self.network_name = 'yang_39_52_295_v2_map'
