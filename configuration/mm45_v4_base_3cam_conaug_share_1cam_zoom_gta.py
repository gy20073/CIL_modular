...
class configInput(configMain):
    def __init__(self):
        ...
        self.val_db_path = glob.glob("/scratch/yang/aws_data/carla_collect/gta/gta_batch*/val/*h5")
        self.train_db_path = glob.glob("/scratch/yang/aws_data/carla_collect/gta/gta_batch*/train/*h5")
