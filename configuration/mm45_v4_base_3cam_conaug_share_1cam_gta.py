...
class configInput(configMain):
    def __init__(self):
        ...
        self.train_db_path = glob.glob("/data/yang/code/aws/scratch/carla_collect/daggerseg_h5/gta_*.h5")
        self.val_db_path = glob.glob("/data/yang/code/aws/scratch/carla_collect/daggerseg_h5/val/gta_*.h5")
