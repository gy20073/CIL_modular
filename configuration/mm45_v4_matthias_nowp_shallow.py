...
class configMain:
    def __init__(self):
        ...
        # 4 conv layers, 1 img FC layer, 1 speed FC layers, 1 joint FC layer, 5 branches X 1 FC layers each
        self.dropout = [0.8] * 4 + [0.5] * 1 + [0.5] * 1 + [0.5] * 1 + [0.5] * len(self.branch_config)
...
class configInput(configMain):
    def __init__(self):
        ...
        self.val_db_path = glob.glob("/data/yang/code/aws/scratch/carla_collect/matthias_converted/val/*.h5")
        self.train_db_path = glob.glob("/data/yang/code/aws/scratch/carla_collect/matthias_converted/train/*.h5")
...
class configTrain(configMain):
    def __init__(self):
        ...
        self.network_name = 'yang_shallow_rgb'
