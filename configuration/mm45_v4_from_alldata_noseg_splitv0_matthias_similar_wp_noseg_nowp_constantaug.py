...
class configInput(configMain):
    def __init__(self):
        ...
        self.val_db_path = glob.glob("/data/yang/code/aws/scratch/carla_collect/matthias_constantaug/val/*.h5")
        self.train_db_path = glob.glob("/data/yang/code/aws/scratch/carla_collect/matthias_constantaug/train/*.h5")
