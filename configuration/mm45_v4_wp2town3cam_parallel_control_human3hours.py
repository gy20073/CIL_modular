...
class configInput(configMain):
    def __init__(self):
        ...
        all_files = glob.glob("/scratch/yang/aws_data/human_driving/converted_wp/*/data_*.h5")
        self.val_db_path = glob.glob("/scratch/yang/aws_data/human_driving/converted_wp/*/data_*5.h5")
