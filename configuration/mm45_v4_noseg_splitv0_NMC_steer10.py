...
class configMain:
    def __init__(self):
        ...
        self.dropout = [1.0] * 8 + [0.5] * 2 + [1.0] * 2 + [0.5] * 1 + [1.0, 1.0] * len(self.branch_config)
...
class configInput(configMain):
    def __init__(self):
        ...
        all_files = glob.glob("/data/yang/code/aws/scratch/carla_collect/noisy_middle_cmdfixed/*/data_*.h5")
        self.val_db_path = glob.glob("/data/yang/code/aws/scratch/carla_collect/noisy_middle_cmdfixed/*WeatherId=13/data_*.h5")
...
class configTrain(configMain):
    def __init__(self):
        ...
        factor = 0.333
        self.training_schedule = [[20000, factor ** 1], [50000, factor ** 2], [80000, factor ** 3],
                                  [110000, factor ** 4]]

        self.branch_loss_weight = [0.95, 0.95, 0.95, 0.95, 0.05]
        self.variable_weight = {'Steer': 1.0, 'Gas': 0.2, 'Brake': 0.1, 'Speed': 1.0}
