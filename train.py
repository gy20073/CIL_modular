...
def train(gpu_number, experiment_name, path, memory_fraction, port):
    ...
    if config.segmentation_model != None:
        ...
        variables_to_restore = slim.get_variables(
            scope=str(config.segmentation_model_name))  # config.segmentation_model_name
        ...
        variables_to_restore = list(set(tf.global_variables()) - set(
            slim.get_variables(scope=str(config.segmentation_model_name))))  # config.segmentation_model_name
    else:
