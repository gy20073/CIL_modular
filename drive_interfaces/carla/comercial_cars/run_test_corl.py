...
if (__name__ == '__main__'):
    ...
    parser.add_argument('-cc', '--carla-config', help="Carla config file used for driving",
                        default="./drive_interfaces/carla_interface/CarlaSettings.ini")
    ...
    driver_conf_module = __import__("3cam_carla_drive_config")
    ...
    runnable = CarlaMachine("0", args.experiment_name, driver_conf)
